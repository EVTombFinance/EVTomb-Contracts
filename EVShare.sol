...
// File contracts/EVShare.sol


pragma solidity 0.6.12;
contract EVShare is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("EVSHARE", "EVSHARE") {
